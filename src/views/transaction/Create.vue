<template>
  <div class="div container my-5">
    <div class="row justify-content-center">
      <div class="col-8">
        <router-link :to="{ name: 'transaction.index' }" class="btn btn-primary btn-sm rounded shadow">Back </router-link>
...
export default {
  setup() {
    ...
    function store() {
      axios.post("http://akunt-api.test/api/transaction", transaction)
        .then(() => {
